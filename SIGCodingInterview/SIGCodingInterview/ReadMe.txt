...
I was mainly struggling with not knowing that STL maps had an lower and upper bound method and wasn't using a binary tree to its full advantage. Instead I choose to use a binary search on an array which was a lot harder to do during an interview.
